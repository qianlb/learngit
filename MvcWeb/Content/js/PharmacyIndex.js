facetsSearch.prototype = $.extend(facetsSearch.prototype, {
    ...
    createFilter: function () {
        ...
        this.setFilterEventListener("#license_type");
    },
...
$(function () {
    var obj = facetsSearch({
        tableUrl: "/Pharmacy/GetPharmacyList",
        tableContainer: "#pharmacy_list",
        filterUrl: "/Pharmacy/GetFacetedSearch",
        saveSearch: {
            saveSearchUrl: "/SaveSearch/GetSaveSearch",
            editchooseColumnUrl: "GetOptionalColumnsForPharmacy",
            savedsearchModuleId: 23,
            optionColumnsModuleId: 62
        }
    });
})