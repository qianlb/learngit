facetsSearch.prototype = $.extend(facetsSearch.prototype, {
    ...
    createFilter: function () {
        ...
        this.setFilterEventListener("#Department");
        this.setFilterEventListener("#Version");
        this.setFilterEventListener("#IssueYear");
    ...
    getRequestParam: function () {
        var json = {},
                filters = $("#facetsSearch .checkbox.checked>input,#facetsSearch label.checked >input,.facetsSearch .checkbox.checked>input,#facetsSearch #IssueDate input,#facetsSearch #formulation select,#ephmra_atc_code select,#ephmra_atc_code select"),
                param = {}, paramStr = [],
                keywordTag;
...
$(function () {
    var obj = facetsSearch({
        tableUrl: "/ClinicalPathway/GetClinicalPathwayList",
        tableContainer: "#ClinicalPathwayList",
        filterUrl: "/ClinicalPathway/GetClinicalPathwayFilters",
        saveSearch: {
            saveSearchUrl: "/SaveSearch/GetSaveSearch",
            editchooseColumnUrl: "GetOptionalColumsForClinicalPathwayView",
            savedsearchModuleId: 19,
            optionColumnsModuleId: 19
        }
    });
});