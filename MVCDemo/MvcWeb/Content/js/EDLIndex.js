facetsSearch.prototype = $.extend(facetsSearch.prototype, {
    ...
    createFilter: function () {
        ...
        this.setFilterEventListener("#national_edl");
    ...
    getRequestParam: function () {
        ...
        //product - basicinfo
        $("#productId").val() ? param["drug"] = [$("#productId").val()] : "";
        // 其它页面搜索
...
$(function () {
    var obj = facetsSearch({
        tableUrl: "/EDL/GetEDLList",
        tableContainer: "#edl_list",
        filterUrl: "/EDL/GetFacetedSearch",
        saveSearch: {
            saveSearchUrl: "/SaveSearch/GetSaveSearch",
            editchooseColumnUrl: "GetOptionalColumnsForEDL",
            savedsearchModuleId: 20,
            optionColumnsModuleId: 60
        }
    });
})