facetsSearch.prototype = $.extend(facetsSearch.prototype, {
    ...
    getRequestParam: function () {
        var json = {},
                filters = $("#facetsSearch .checkbox.checked>input,#facetsSearch label.checked >input,.facetsSearch .checkbox.checked>input,#facetsSearch #certificatedate input,#facetsSearch #expirydate input,#facetsSearch #formulation select,#ephmra_atc_code select,#ephmra_atc_code select"),
                param = {}, paramStr = [],
                keywordTag;
    ...
    setOptionColumnLinstener: function () {
        ...
        var tabType,
            modelID = 10,
            url = "/OptionalColum/GetOptionalColumnsForGMPViewCertification";
    ...
    createFilter: function () {
        ...
        this.setFilterEventListener("#version");
        this.setFilterEventListener("#validity");
        this.setFilterEventListener("#certificatedate");
        this.setFilterEventListener("#expirydate");
    },
})
facetsSearch.prototype.init.prototype = facetsSearch.prototype
$(function () {
    var obj = facetsSearch({
        tableUrl: "/GMP/GetGMPCertificationList",
        tableContainer: "#GmpCertificationCon",
        filterUrl: "/GMP/GetGMPFilters",
        saveSearch: {
            saveSearchUrl: "/SaveSearch/GetSaveSearch",
            savedsearchModuleId: 9,
        }
    });
});
